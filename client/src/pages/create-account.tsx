...
export default function CreateAccountPage() {
  ...
  const getPlatformUrl = () => {
    ...
    return `${noDomainPrefix}.golfjunkies.com`;
  };
  ...
  const leftPanelContent: Record<OnboardingStep, { heading: string; description: string }> = {
    register: {
      heading: "Launch Your Golf Community",
      description:
        "Your golf community could be fully onboarded and live within 24 hours. No technical skills needed, just a simple process will open your platform to your full community.",
    },
    identity: {
      heading: "Set Up Your Platform",
      description:
        "Configure how your members will access your golf community. Choose your domain and make it yours.",
    },
    terms: {
      heading: "One Last Step",
      description:
        "Review and accept our terms and conditions to get your golf community up and running.",
    },
  };
      ...
      <header className="w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          <Link href="/" className="flex items-center gap-2" data-testid="link-home">
            ...
            <span className="text-xl font-bold text-foreground">Golf Junkies</span>
          </Link>
        </div>
      </header>
                      ...
                      {hasDomain === false && (
                        <div className="space-y-4">
                          <p className="text-sm text-muted-foreground">
                            You can use the GolfJunkies.com domain (and change later).
                          </p>
                  ...
                  {step === "terms" && (
                    <div className="space-y-5">
                      <div className="border border-border rounded-md p-4 max-h-[340px] overflow-y-auto text-sm text-muted-foreground space-y-4" data-testid="terms-content">
                        <h3 className="font-bold text-foreground text-base">Golf Junkies Platform Terms & Conditions</h3>
                        <p className="font-semibold text-foreground">1. Acceptance of Terms</p>
                        <p>By creating an account and using the Golf Junkies platform, you agree to be bound by these Terms and Conditions. If you do not agree, please do not proceed with account creation.</p>
                        <p className="font-semibold text-foreground">2. Platform Usage</p>
                        <p>The Golf Junkies platform is provided as a Software-as-a-Service (SaaS) solution for managing golf communities, clubs, and related organisations. You agree to use the platform only for its intended purpose and in compliance with all applicable laws.</p>
                        <p className="font-semibold text-foreground">3. Account Responsibilities</p>
                        <p>You are responsible for maintaining the confidentiality of your account credentials. You agree to notify Golf Junkies immediately of any unauthorised use of your account. You are responsible for all activities that occur under your account.</p>
                        ...
                        <p>You retain ownership of all content you upload to the platform. By uploading content, you grant Golf Junkies a licence to host and display that content as part of the service. You must not upload content that is unlawful, offensive, or infringes on third-party rights.</p>
                        ...
                        <p>Golf Junkies shall not be liable for any indirect, incidental, or consequential damages arising from the use of the platform. Our total liability shall not exceed the fees paid by you in the preceding 12 months.</p>
