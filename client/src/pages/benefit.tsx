...
const benefitsData = {
  "member-engagement": {
    ...
    subtitle: "Build a thriving, active golf community",
    heroDescription: "Keep your golf community active and connected with social features designed specifically for golfers. Create meaningful interactions that bring members together both on and off the course.",
    colorClass: "bg-gradient-to-br from-emerald-500 to-emerald-600 text-white",
    details: [
      {
        heading: "Social Networking for Golfers",
        description: "Give your members a dedicated space to connect, share experiences, and build relationships. Our social features include member profiles, activity feeds, direct messaging, and group discussions - all tailored for the golfing community."
      },
      {
  ...
  "simplify-management": {
    ...
    heroDescription: "Streamline administrative tasks with powerful tools that save time and reduce complexity. Manage your entire golf community from one intuitive dashboard.",
  ...
  "inter-club-play": {
    ...
    subtitle: "Expand your golfing network",
    heroDescription: "Expand your network with reciprocal play arrangements and inter-club competitions. Connect your members with golf communities across the region and beyond.",
    colorClass: "bg-gradient-to-br from-emerald-500 to-emerald-600 text-white",
    details: [
      {
        heading: "Reciprocal Play Arrangements",
        description: "Easily set up and manage reciprocal play agreements with other clubs. Your members gain access to new courses while you welcome visiting golfers to yours."
      },
      {
      ...
      },
      {
        ...
        description: "Discover and connect with golf communities in your region. Build relationships that benefit your members and grow the wider golfing community."
      }
    ]
  },
  "revenue-streams": {
    ...
    details: [
      ...
      },
      {
        ...
        description: "Partner with golf brands, pro shops, and local businesses. Share exclusive offers with your members while earning referral revenue."
      }
    ]
  },
  "improve-retention": {
    ...
    details: [
      {
        ...
        description: "Foster a sense of belonging that goes beyond just playing golf. Members who feel connected to their community are far more likely to renew and stay active."
      },
      {
      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-4 gap-4">
        <Link href="/" data-testid="link-header-logo">
          <div className="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span className="font-bold text-xl hidden sm:inline">Golf Junkies</span>
          </div>
        </Link>
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            <img src={logoPath} alt="Golf Junkies" className="h-8 w-8 object-contain" />
            <span className="font-bold">Golf Junkies</span>
          </div>
...
export default function BenefitPage() {
  ...
  useEffect(() => {
    ...
    if (benefit) {
      const benefitTitle = `${benefit.title} | Golf Junkies`;
      ...
      document.title = "Benefit Not Found | Golf Junkies";
    }
